...
void lineLimitSet() {//入力枝数に対して出力枝数の確率(最高6分岐)
  ...
  linelimitPerRow.put(1, new float[]{0.1, 0.000, 0.123, 0.246, 0.140, 0.000, 0.018, 1.00});
  linelimitPerRow.put(2, new float[]{0, 0.028, 0.008, 0.272, 0.192, 0.016, 0.484, 1.00});
  linelimitPerRow.put(3, new float[]{0, 0.114, 0.553, 0.000, 0.000, 0.008, 0.325, 1.00});
  linelimitPerRow.put(4, new float[]{0, 0.095, 0.571, 0.000, 0.333, 0.000, 0.000, 1.00});
  linelimitPerRow.put(5, new float[]{0, 0, 0.8, 0.2, 0, 0, 0, 1.00});
  linelimitPerRow.put(6, new float[]{0, 0.006, 0.747, 0.247, 0.000, 0.000, 0.000, 1.00});
